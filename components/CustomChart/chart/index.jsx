...
function Chart() {
  ...
  useEffect(() => {
    const documentElement = ElementRef.current;
    let chart = createChart(documentElement, {
      width: 500,
      height: 400,
      color: 'white',
      leftPriceScale: {
    ...
    new ResizeObserver((entries) => {
      if (entries.length === 0 || entries[0].target !== documentElement) {
        return;
      }
    ...
    var areaSeries = chart.addAreaSeries({
      topColor: 'rgba(117,228,170, 1)',
      bottomColor: 'rgba(117,228,170, 0)',
      lineColor: 'rgba(117,228,170, 1)',
      lineWidth: 2,
    });
    areaSeries.setData([
