...
import {CreateTokenBackButton, CreateTokenFormControl, CreateTokenFormLabel, CreateTokenNextButton, CreateTokenSecondLabel, CreateTokensContentContainer} from "../create_token_sales_widget";
import React from "react";
import ClearFix from "../../ClearFix/ClearFix";
import CreateTokenTextForm from "../CreateTokenTextForm";

const CreatePresaleAdditionalInfo = ({onNext, onBack}) => {
    return (
...
export default CreatePresaleAdditionalInfo;