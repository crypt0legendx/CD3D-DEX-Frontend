import {FormControlLabel, Grid, InputAdornment, MenuItem, Radio, RadioGroup, Select, Stack} from "@mui/material";
import {CreateTokenBackButton, CreateTokenFormControl, CreateTokenFormLabel, CreateTokenHelperText, CreateTokenNextButton, CreateTokenRadio, CreateTokenSecondLabel, CreateTokensContentContainer, CreateTokenSelect} from "../create_token_sales_widget";
import React from "react";
import ClearFix from "../../ClearFix/ClearFix";
import CreateTokenTextForm from "../CreateTokenTextForm";
import DateRangeIcon from '@mui/icons-material/DateRange';

const CreatePresaleLaunchInfo = ({onNext, onBack}) => {
...
export default CreatePresaleLaunchInfo;